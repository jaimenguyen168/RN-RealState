import {View, Text, ScrollView, Dimensions, Image, Platform, TouchableOpacity, FlatList} from 'react-native'
...
const Property = () => {
  ...
  return (
    <View>
      ...
      >
        <View className="relative w-full" style={{ height: halfWindowHeight }}>
          ...
          <Image
            ...
            className="absolute -top-8 w-full z-40 rotate-180"
          />

          <View className={`z-50 absolute inset-x-7 ${Platform.OS === 'ios' ? "top-[70px]" : "top-[20px]"}`}>
            <View className="flex flex-row items-center justify-between">
              <TouchableOpacity
                className="bg-primary-100 size-11 items-center justify-center rounded-full"
                onPress={() => router.back()}
              >
                <Image
        ...
        <View className="px-5 mt-7 flex gap-4">
          ...
          <View className="w-full border-t border-primary-200 pt-6 mt-4">
          ...
          <View className="w-full mt-4">
            ...
            {property?.facilities.length > 0 && (
              <View className="flex flex-row flex-wrap items-start justify-start mt-2 gap-4">
      ...
      <View className="absolute bg-white bottom-0 w-full rounded-t-3xl border-t border-r border-l border-primary-200 p-7">
